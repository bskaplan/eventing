...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnDiskChannel) DeepCopyInto(out *OnDiskChannel) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnDiskChannel.
func (in *OnDiskChannel) DeepCopy() *OnDiskChannel {
	if in == nil {
		return nil
	}
	out := new(OnDiskChannel)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *OnDiskChannel) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnDiskChannelList) DeepCopyInto(out *OnDiskChannelList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]OnDiskChannel, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnDiskChannelList.
func (in *OnDiskChannelList) DeepCopy() *OnDiskChannelList {
	if in == nil {
		return nil
	}
	out := new(OnDiskChannelList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *OnDiskChannelList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnDiskChannelSpec) DeepCopyInto(out *OnDiskChannelSpec) {
	*out = *in
	if in.Subscribable != nil {
		in, out := &in.Subscribable, &out.Subscribable
		*out = new(duckv1alpha1.Subscribable)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnDiskChannelSpec.
func (in *OnDiskChannelSpec) DeepCopy() *OnDiskChannelSpec {
	if in == nil {
		return nil
	}
	out := new(OnDiskChannelSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnDiskChannelStatus) DeepCopyInto(out *OnDiskChannelStatus) {
	*out = *in
	in.Status.DeepCopyInto(&out.Status)
	in.AddressStatus.DeepCopyInto(&out.AddressStatus)
	in.SubscribableTypeStatus.DeepCopyInto(&out.SubscribableTypeStatus)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnDiskChannelStatus.
func (in *OnDiskChannelStatus) DeepCopy() *OnDiskChannelStatus {
	if in == nil {
		return nil
	}
	out := new(OnDiskChannelStatus)
	in.DeepCopyInto(out)
	return out
}
