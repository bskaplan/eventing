...
// Converts source (from v1alpha1.OnDiskChannel) into v1beta1.OnDiskChannel
func (source *OnDiskChannel) ConvertTo(ctx context.Context, obj apis.Convertible) error {
	switch sink := obj.(type) {
	case *v1beta1.OnDiskChannel:
...
func (source *OnDiskChannelSpec) ConvertTo(ctx context.Context, sink *v1beta1.OnDiskChannelSpec) error {
...
// ConvertTo helps implement apis.Convertible
func (source *OnDiskChannelStatus) ConvertTo(ctx context.Context, sink *v1beta1.OnDiskChannelStatus) {
	source.Status.ConvertTo(ctx, &sink.Status)
...
// Converts obj v1beta1.OnDiskChannel into v1alpha1.OnDiskChannel
func (sink *OnDiskChannel) ConvertFrom(ctx context.Context, obj apis.Convertible) error {
...
func (sink *OnDiskChannelSpec) ConvertFrom(ctx context.Context, source v1beta1.OnDiskChannelSpec) {
	sink.Delivery = source.Delivery
...
// ConvertFrom helps implement apis.Convertible
func (sink *OnDiskChannelStatus) ConvertFrom(ctx context.Context, source v1beta1.OnDiskChannelStatus) error {
	source.Status.ConvertTo(ctx, &sink.Status)
	if source.AddressStatus.Address != nil {
