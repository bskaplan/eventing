...
const (
	defaultControllerAgentName = "ondiskchannel-controller"
	defaultFinalizerName       = "ondiskchannels.messaging.knative.dev"
	defaultQueueName           = "ondiskchannels"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:     ondiskchannelInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
