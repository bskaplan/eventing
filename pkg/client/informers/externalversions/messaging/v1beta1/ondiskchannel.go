...
type OnDiskChannelInformer interface {
	...
	Lister() v1beta1.OnDiskChannelLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MessagingV1beta1().OnDiskChannels(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MessagingV1beta1().OnDiskChannels(namespace).Watch(options)
			},
		},
		&messagingv1beta1.OnDiskChannel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *onDiskChannelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&messagingv1beta1.OnDiskChannel{}, f.defaultInformer)
}

func (f *onDiskChannelInformer) Lister() v1beta1.OnDiskChannelLister {
	return v1beta1.NewOnDiskChannelLister(f.Informer().GetIndexer())
}
