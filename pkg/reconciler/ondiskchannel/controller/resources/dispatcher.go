...
var (
	dispatcherLabels = map[string]string{
		"messaging.knative.dev/channel": "on-disk-channel",
...
// MakeDispatcher generates the dispatcher deployment for the on-disk channel
func MakeDispatcher(args DispatcherArgs) *v1.StatefulSet {
	replicas := int32(1)
...
func makeEnv() []corev1.EnvVar {
	return []corev1.EnvVar{{
		...
		Name:  "METRICS_DOMAIN",
		Value: "knative.dev/ondiskchannel-dispatcher",
	}, {
